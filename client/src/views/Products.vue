...
async function loadProducts(){
    ...
    }else if(undefined != selectCate){
        products.value = await searchCategory(selectCate);
        console.log("넘어온 카테고리값 : " + selectCate);
    }
}
...
function highPrice(){//내림차순
    this.products.value  = products.value.sort((a, b) => (a['price'] < b['price'] ? 1 : -1));
...
// if(paraCate & 'undefined'!=paraCate){
//     searchCategory(paraCate);
//     console.log('들어옴')
// }
